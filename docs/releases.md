...
Container Pilot uses [Semantic Versioning](https://semver.org/). Release candidates use tags such as `v0.9.0-rc.9`; stable releases use tags such as `v1.0.0`.

## Channels

| Git tag | Published image tags | Intended use |
| --- | --- | --- |
| `v0.9.0-rc.9` | `0.9.0-rc.9`, `rc` | controlled release-candidate testing |
