<div align="center">
  ...
  <p>
    <img alt="Version 0.5.1" src="https://img.shields.io/badge/Version-0.5.1-087f8c">
...
> **Projektstatus:** Version 0.5.1 befindet sich in aktiver Entwicklung. Vor dem produktiven Einsatz sollten Update- und Rollback-Verhalten mit den eingesetzten Containern, Netzwerken und Volumes getestet werden.
...
| **Container** | Name, Container-ID, Image, Laufzeitstatus und Updatezustand in einer gemeinsamen Liste einsehen |
| **Update-Prüfung** | Docker Hub und GHCR anhand der Image-Manifeste und Digests prüfen |
